...
namespace Common\Common;
 ...
 //获取access_token并保存到token.txt文件中
    public static function build_access_token(){
        ...
        curl_setopt($ch, CURLOPT_URL, "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx8756da0fb4beab21&secret=1eee0ff03496add86a30813e8d862fbb");//设置你所需要抓取的URL
